...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_x(ui_power1, 94);
    lv_obj_set_y(ui_power1, 59);
    ...
    lv_label_set_text(ui_Label2, "CURRENT");
    ...
    lv_label_set_text(ui_Label5, "FABRIKEN");
    ...
    lv_label_set_text(ui_Label6, "LASER");
